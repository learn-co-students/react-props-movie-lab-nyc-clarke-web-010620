  ...
  render() {
    return (
      <div className="movie-card">
        ...
        <CardFront title={this.props.title} genres={this.props.genres} poster={this.props.poster}/>
        <CardBack title={this.props.title} IMDBRating={this.props.IMDBRating} poster={this.props.poster}/>
      </div>
    )
  }
}
